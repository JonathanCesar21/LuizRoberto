...
<div class="container">
    <div class="row">
        <div class="col-md-12 text-center icons-px text-info">
            <h2 data-aos="fade-up" data-aos-duration="1500">Quem Sou?</h2>
            <img src="img/icons/carne.png" alt="" data-aos="fade-right" data-aos-duration="1500">
            <img src="img/icons/trigo.png" alt="" data-aos="fade-left" data-aos-duration="1500">
        </div>
    </div>
</div>
<div  class="container bg-card ">
    <div class="row ">
        ...
        <div class="col-md-6 text-center luiz-img" data-aos="fade-left" data-aos-duration="1500">
...
<div class="container-flex bg-color paciente-img">
    <div class="row">
        ...
        <div class="col-md-4 text-center" data-aos="fade-right" data-aos-duration="1500">
            <img src="img/paciente1.jpg" alt="">
        </div>
        <div class="col-md-4 text-center" data-aos="fade" data-aos-duration="1500">
            <img src="img/paciente9.png" alt="">
        </div>
        <div class="col-md-4 text-center" data-aos="fade-left" data-aos-duration="1500">
...
<div class="container-flex text-info bg-color-white img-insta">
    <div class="row">
        ...
        <div class="col-md-4 text-center" data-aos="fade-right" data-aos-duration="1300">
            <img src="img/pacienteinsta1.png" alt="">
        </div>
        <div class="col-md-4 text-center" data-aos="fade" data-aos-duration="1300">
            <img src="img/pacienteinsta7.png" alt="">
        </div>
        <div class="col-md-4 text-center" data-aos="fade-left" data-aos-duration="1300">
